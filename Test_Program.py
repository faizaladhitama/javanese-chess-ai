...
class BoardTestCase(unittest.TestCase):
    ...
    def test_possible_move(self):
        assert self._board.possible_move(self._board.select_node(0)) == ['7', '8']
    ...
    def test_column_win(self):
        self._board.pawn_transition(self._board.select_node(0), self._board.select_node(7))
        self._board.pawn_transition(self._board.select_node(6), self._board.select_node(8))
        self._board.pawn_transition(self._board.select_node(7), self._board.select_node(6))
        self._board.pawn_transition(self._board.select_node(8), self._board.select_node(3))
        self._board.pawn_transition(self._board.select_node(1), self._board.select_node(0))
        self._board.pawn_transition(self._board.select_node(5), self._board.select_node(8))
    ...
    def test_row_win(self):
        self._board.pawn_transition(self._board.select_node(0), self._board.select_node(7))
        self._board.pawn_transition(self._board.select_node(1), self._board.select_node(8))
        self._board.pawn_transition(self._board.select_node(2), self._board.select_node(3))
    ...
    def test_utility_ai_win_column(self):
        ...
        self._board.pawn_transition(self._board.select_node(5), self._board.select_node(4))
        self._board.pawn_transition(self._board.select_node(2), self._board.select_node(1))
        self._board.pawn_transition(self._board.select_node(6), self._board.select_node(5))
        self._board.pawn_transition(self._board.select_node(8), self._board.select_node(7))
        self._board.pawn_transition(self._board.select_node(3), self._board.select_node(2))
        self._board.pawn_transition(self._board.select_node(4), self._board.select_node(3))
        self._board.pawn_transition(self._board.select_node(5), self._board.select_node(4))
        assert self._board.utility() == 1
    ...
    def test_utility_ai_win_diagonal(self):
        self._board.pawn_transition(self._board.select_node(2), self._board.select_node(3))
        self._board.pawn_transition(self._board.select_node(3), self._board.select_node(8))
        self._board.pawn_transition(self._board.select_node(8), self._board.select_node(7))
        self._board.pawn_transition(self._board.select_node(4), self._board.select_node(3))
        self._board.pawn_transition(self._board.select_node(3), self._board.select_node(2))
        self._board.pawn_transition(self._board.select_node(5), self._board.select_node(8))
